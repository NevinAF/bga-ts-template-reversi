...
**[BGA Type Safe Template: Reverse Tutorial](https://github.com/NevinAF/bga-ts-template/blob/main/docs/tutorials/reversi.md)**: See the tutorial documentation for this game here.
